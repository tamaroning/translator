...
if should_train:
    ...
    print("Saving models")
    torch.save(encoder.state_dict(), "params/encoder.pt")
    torch.save(decoder.state_dict(), "params/decoder.pt")
else:
    print("Loading models")
    encoder.load_state_dict(torch.load("params/encoder.pt"))
    decoder.load_state_dict(torch.load("params/decoder.pt"))
